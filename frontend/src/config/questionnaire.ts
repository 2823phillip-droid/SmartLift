  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        preface: "How would you like to include cardio?",
        options: [
          { value: "none", label: "Lift Only — no cardio" },
          { value: "warmup_run_10", label: "Warmup Run — 10 min before lifting" },
          { value: "warmup_run_15", label: "Warmup Run — 15 min before lifting" },
          { value: "warmup_run_20", label: "Warmup Run — 20 min before lifting" },
          { value: "finisher_run_10", label: "Finisher Run — 10 min after lifting" },
          { value: "finisher_run_15", label: "Finisher Run — 15 min after lifting" },
          { value: "finisher_run_20", label: "Finisher Run — 20 min after lifting" },
          { value: "hiit_finisher", label: "HIIT Finisher — 15 min high intensity after lifting" },
          { value: "separate_cardio", label: "Separate Cardio Day — keep it on its own day" },
          { value: "custom", label: "Custom — I'll decide per session" },
        ],
        default: "none",
      },
      {
